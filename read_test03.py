...
test_d0 = 'C:/Users/mingfeng.zhou/Desktop/standard_mockup/BGB-3111-207 CSR TFL shell draft v1.1_20190610.docx'
files=[test_d0]
files=files
...
for fn,test_d in enumerate(files):
    ...
    for i,paragraph in enumerate(document.paragraphs):
        ...
        if text.strip().startswith('Data source:') or text.strip().startswith('Source:'):
            datasource_num=i
            protocol_flag=0
