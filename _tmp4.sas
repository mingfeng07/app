...
** Call macro %m_t_ae to generate table:  TEAE Leading to Death by System Organ Class and Preferred Term;            
...
%m_t_ae(            
    ...
    ,observation_where    =    %str(TRTEMFL="Y" and AEOUT="FATAL" )
    ...
    ,output_lib    =    &tables
    ,support_listing_lib    =    
    ,rename_output    =    t-teae-socpt-dth
...
** Call macro %m_t_ae to generate table:  Treatment-related TEAE Leading to Death by System Organ Class and Preferred Term;            
proc datasets lib=work memtype=data nolist nowarn; save adsl adae; run;            
%m_t_ae(            
     population_from    =    adsl
    ,population_where    =    %str(SAFFL='Y' )
    ,observation_from    =    adae
    ,observation_where    =    %str(TRTEMFL="Y" and AEOUT="FATAL" and (relgr2="RELATED" or relgr3="RELATED"))
    ,therapy_des_var    =    trt01a
    ,therapy_cd_var    =    
    ,aetrt_des_var    =    trt01a
    ,aetrt_cd_var    =    
    ...
    ,output_lib    =    &tables
    ,support_listing_lib    =    
    ,rename_output    =    t-teae-socpt-rel-dth
    ,decimal_places_percent    =    1
    ,font_size    =    regular
    ,trackerid       = &titlesid.
    ,debug    =    N
